...
public class UserRepository {
	...
	public List<User> findAll() {
		...
		users.add(new User(1, "irone", "1234", "0101234"));
		users.add(new User(2, "doyeck", "1234", "0101234"));
		users.add(new User(3, "jeongcheol", "1234", "0101234"));
		return users;
	}
	
	public User findById(int id) {
		return new User(1, "irone", "1234", "0101234");
	}
